module GLSL.Shader exposing (shader)
...
import GLSL.Types exposing (Uniforms, Vertex)


shader : WebGL.Shader {} Uniforms { vcolor : Vec3 }
shader =
    [glsl|
    ...
    void main(){
      ...
      scale = noise(vec3(p+1.,0.));

      // color += vec4(displacement, 0., 0.);
