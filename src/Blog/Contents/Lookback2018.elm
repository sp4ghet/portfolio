...
secondText =
    """
僕のセットのソースコードは[ここにあげているので](https://github.com/sp4ghet/vj-infiniterave)Unityが好きな皆さんは見てみてください。
...
言語処理系の勉強がしたくて今年の上旬は[Lisp処理系](https://github.com/sp4ghet/slip)の実装をしたり、今はLLVMの本を読んだりしています。
来年は型とかについて勉強したいです。
